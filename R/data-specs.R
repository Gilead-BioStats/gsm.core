...
#' }
#' @source Generated from `analyticsInput.csv` dataset in the `gsm.core` package.
"analyticsInput"
...
#' }
#' @source Generated from `analyticsSummary.csv` dataset in the `gsm.core` package.
"analyticsSummary"
...
#' }
#' @source Generated from `reportingGroups.csv` dataset in the `gsm.core` package.
"reportingGroups"
...
#' }
#' @source Generated from `reportingBounds.csv` dataset in the `gsm.core` package.
"reportingBounds"
...
#'   \item{Value}{Value of specified Param}
#' }
#' @source Generated from `reportingGroups_country.csv` dataset in the `gsm.core` package.
...
#'   \item{SnapshotDate}{date of the snapshot}
#' }
#' @source Generated from `reportingBounds_country.csv` dataset in the `gsm.core` package.
