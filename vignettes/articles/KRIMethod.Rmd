---
title: "KRI Method"
description: "This vignette outlines the statistical methods used to evaluate Key Risk Indicators (KRIs) in {gsm.core}."
...
This vignette outlines the statistical methods used to evaluate Key Risk Indicators (KRIs) in {gsm.core}. KRIs are metrics that allow users to measure pre-defined risks and determine the level of observed risk to data quality and patient safety in a clinical trial. The {gsm.core} package implements a standardized data pipeline to facilitate KRI analysis. Other vignettes provide an overview of this framework ([1](../), [2](Cookbook.html) [3](DataModel.html), [4](DataAnalysis.html),
