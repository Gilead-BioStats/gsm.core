...
Examples of these yamls can be found above in the `Module Configuration` section, as well as in the [Data Analysis Vignette](https://gilead-biostats.github.io/gsm.core/articles/DataAnalysis.html).
...
Examples of these yamls can be found above in the `Module Configuration` section, as well as in [Data Reporting Vignette](https://gilead-biostats.github.io/gsm.reporting/articles/DataReporting.html).
